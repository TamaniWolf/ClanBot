                                ...
                                if (err) 
                                    ...
                                    switch (1) {
                                        case 1:
                                            ...
                                            // console.log(cooldownnewjoinread.cooldown);
                                            ...
                                            if (timeNow < cooldownnewjoin) {
                                                ...
                                                console.log(chalk.cyan('[' + moment.utc().format('MM/DD/YYYY-h:mm:ss-A') + ']' + lang.prefix.royal, `NewJoin Cooldown of '${newjoinmembername}' is resetted.`));
                                            } else {
                                                return;
                                            };
                                    }
