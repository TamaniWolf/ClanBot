    ...
    static data(guild) {
        ...
        if (globalclient) {
            ...
            if (dataOnOffCommandMember == null) {
                dataOnOffCommandMember = { OnOffID: `${getBotConfigId}`, GuildID: `${getClientGuildId}`, Convert: `true`, Eval: `true`, Birthday: `false`, Blush: `true`, Grouphug: `true`, Growl: `true`, Hug: `true`, Hydrate: `true`, Slap: `true`, Help: `true`, Achievements: `true`, Profile: `true` };
            ...
            // if (dataProfile == null) {
            //     dataProfile = { ProfileID: `${getMemberId}`, GuildID: `${getClientGuildId}`, MemberID: `${getClientUserId}`, DisplayName: `${globalclient.user.username}`, Nickname: `${globalclient.user.nickname}`, Consent: `false` };
            //     Set.profile(dataProfile);
            // };
            // let dataScores;
            // dataScores = Get.scores(getMemberId);
            // if (dataScores == null) {
            //     dataScores = { ProfileID: `${getMemberId}`, GuildID: `${getClientGuildId}`, MemberID: `${getClientUserId}`, Exp: `0`, Level: `0` };
            //     Set.scores(dataMemberScores);
            // };
            // let dataAchievements;
            // dataAchievements = Get.achievements(getMemberId);
            // if (dataAchievements == null) {
            //     dataAchievements = { AchievementsID: `${getMemberId}`, GuildID: `${getClientGuildId}`, Bitfield: `${getClientUserId}`, Background: `${globalclient.user.username}`, Icon: `${globalclient.user.nickname}`, Rarity: `false` };
